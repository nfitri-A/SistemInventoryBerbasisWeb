...
%>
              <div class="col-md-6">
                    <div class="form-group">
                        <label  class="col-sm-2 control-label">Di terima oleh</label>
                        <div class="col-sm-10">
...
<div class="product-status-wrap">
        <h4>Data Barang Out</h4>
            <table class="table table-hover table-striped table-bordered" id="datatable">
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="stockoutServlet?kode=<%=rs.getString(2)%>&aksi=Delete" ><button type="button" class="btn btn-danger">Delete</button>
                        </td>
                    </tr>
                  <%}%>
    ...
    <form method="POST" action="stockoutServlet">
            <div class="row">
