<%-- 
    Document   : tambahstockout
    Created on : May 21, 2020, 8:25:02 PM
    Author     : fitri
--%>
...
<div class="container">
          <h2 class="alert alert-info text-center"  >INPUT STOCK OUT</h2>
          <a href="beranda.jsp?hal=tampilstockout"><button type="button" class="btn btn-info">Lihat Data</button></a><br/><br/>
          <form method="POST"  class="form-horizontal" role="form" >
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label  class="col-sm-2 control-label">Kode Stock Out</label>
                        <div class="col-sm-10">
                            <label><%=nomor%>
...
%>
              <div class="col-md-6">
                    <div class="form-group">
                        <label  class="col-sm-2 control-label">Di keluarkan oleh</label>
                        <div class="col-sm-10">
...
<div class="product-status-wrap">
        <h4>Data Barang Out</h4>
            <table class="table table-hover table-striped table-bordered" id="datatable">
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="../admstockoutServlet?kode=<%=rs.getString(2)%>&aksi=Delete" ><button type="button" class="btn btn-danger">Delete</button></a>
                        </td>
                    </tr>
                  <%}%>
    ...
    <form method="POST" action="../admstockoutServlet">
            <div class="row">
                       ...
                       <div class="form-group data-custon-pick">
                            <div class="form-group data-custon-pick">
                                <div class="input-group mg-b-pro-edt" class="col-lg-4 col-md-4 col-sm-4 col-xs-6">     
                                    ...
                                    <input type="hidden" name="kd_brg_klr"
                                       value="<%=nomor%>"/>
                                    <input type="hidden" name="tgl"
                                           value="<%=tgl%>"/>
                                    <input type="hidden" name="kd_karyawan"
                                           value="<%=kd_karyawan%>"/>
