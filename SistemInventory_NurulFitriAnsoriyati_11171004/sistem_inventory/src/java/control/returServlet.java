 ...
 * @author fitri
 */
public class returServlet extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.print("<script>"
                    ...
                    + "window.location='beranda.jsp?hal=tampilretur';"
                    + "</script>");
            else
            out.print(sql+"<script>"
                    + "alert('Data Gagal di "+aksi+"');"
                    + "window.location='beranda.jsp?hal=tambahretur';"
                    + "</script>");
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(returServlet.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(returServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
