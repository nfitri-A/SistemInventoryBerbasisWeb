 ...
 * @author fitri
 */
public class admpemesananServlet extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.print("<script>"
                    ...
                    + "window.location='Admin_Gudang/beranda.jsp?hal=tampilpemesanan';"
                    + "</script>");
            else
            out.print(sql+"<script>"
                    + "alert('Data Gagal di "+aksi+"');"
                    + "window.location='Admin_Gudang/beranda.jsp?hal=tambahpemesanan';"
                    + "</script>");
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(admpemesananServlet.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(admpemesananServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
