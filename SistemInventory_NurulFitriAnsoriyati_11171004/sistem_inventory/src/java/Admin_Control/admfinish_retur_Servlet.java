 ...
 * @author fitri
 */
public class admfinish_retur_Servlet extends HttpServlet {
        ...
        response.setContentType("text/html;charset=UTF-8");
         try (PrintWriter out = response.getWriter()) {
            ...
            out.print("<script>"
                    ...
                    + "window.location='Admin_Gudang/beranda.jsp?hal=tambahfinishretur';"
                    + "</script>");
            else
            ...
            Logger.getLogger(admfinish_retur_Servlet.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(admfinish_retur_Servlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
