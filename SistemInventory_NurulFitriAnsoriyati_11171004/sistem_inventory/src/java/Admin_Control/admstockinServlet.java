 ...
 * @author fitri
 */
public class admstockinServlet extends HttpServlet {
        ...
        response.setContentType("text/html;charset=UTF-8");
         try (PrintWriter out = response.getWriter()) {
            ...
            out.print("<script>"
                    ...
                    + "window.location='Admin_Gudang/beranda.jsp?hal=tambahstockin';"
                    + "</script>");
            else
            ...
            Logger.getLogger(admstockinServlet.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(admstockinServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }   
