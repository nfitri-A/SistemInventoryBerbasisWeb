...
%>
    ...
    <div class="container">
        <div class="row">
          ...
          <form method="POST"  action="stockinServlet" class="form-horizontal" role="form" >
            <div class="row">
                <div class="col-md-6">
            ...
            <h4>Data Barang Pemesanan</h4>
               <table class="table table-hover table-striped table-bordered" id="datatable">
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="stockinServlet?kode=<%=rs.getString(2)%>&aksi=Delete" ><button type="button" class="btn btn-danger">Delete</button>
                            </td>
                        </tr>
                      <%}%>
